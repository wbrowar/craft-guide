import{n as f,t as x,h as C,k as r,D as c,i as z,r as p,a as F,p as O,R as H,l as j,g as D,u as N}from"./console-D77ky1jy.js";import{G as $,E as u,A as m,P as v,a as J,M as A}from"./types-BjkgCq3a.js";async function R(i){if(navigator.clipboard&&window.isSecureContext)await navigator.clipboard.writeText(i);else{const t=document.createElement("textarea");t.value=i,t.classList.add("sr-only"),document.body.prepend(t),t.select();try{document.execCommand("copy")}catch(s){console.error(s)}finally{t.remove()}}}var V=Object.defineProperty,W=Object.getOwnPropertyDescriptor,k=(i,t,s,a)=>{for(var e=a>1?void 0:a?W(t,s):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(e=(a?n(t,s,e):n(e))||e);return a&&e&&V(t,s,e),e};let G=class extends C{constructor(){super(...arguments),this.tMessages={},this.copyText=""}async _copyTextToClipboard(i){await R(i),window.Craft.cp.displayNotice(`${this.tMessages.copiedToClipboard}: ${i}`)}async connectedCallback(){super.connectedCallback()}render(){return r`${this.copyText&&this.tMessages?r`
          <div
      ...
      <aside>
        ...
        >
          ...
          ${O&&this._contentSource===$.Field?i:c}
        </div>
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class U extends Z{constructor(t){if(super(t),this.it=c,t.type!==Q.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===c||t==null)return this._t=void 0,this.it=t;if(t===H)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const s=[t];return s.raw=s,this._t={_$litType$:this.constructor.resultType,strings:s,values:[]}}}U.directiveName="unsafeHTML",U.resultType=1;const B=X(U);var tt=Object.defineProperty,et=Object.getOwnPropertyDescriptor,L=(i,t,s,a)=>{for(var e=a>1?void 0:a?et(t,s):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(e=(a?n(t,s,e):n(e))||e);return a&&e&&tt(t,s,e),e};let P=class extends C{constructor(){super(...arguments),this.data=void 0,this.tMessages={},this._showProps=!1}_insertTextIntoEditor(i,t){var e;let s;t==="content"?s=globalThis.monacoEditorInstances.contentEditor:t==="css"?s=globalThis.monacoEditorInstances.contentCss:t==="javascript"&&(s=globalThis.monacoEditorInstances.contentJavascript);const a=(e=document.querySelector("guide-editor"))==null?void 0:e.dataset.guideSlug;if(a){const o=new Date;i=i.replace(/REPLACE_DATE/g,o.toISOString().split("T")[0]).replace(/REPLACE_GUIDE_SLUG/g,a)}if(s){const o=s.getModel().getLineCount(),n=s.getModel().getLineMaxColumn(o),l=s.getSelection(),b={identifier:{major:1,minor:1},range:{startLineNumber:(l==null?void 0:l.selectionStartLineNumber)??o,startColumn:(l==null?void 0:l.selectionStartColumn)??n,endLineNumber:(l==null?void 0:l.endLineNumber)??o,endColumn:(l==null?void 0:l.endColumn)??n},text:i,forceMoveMarkers:!0};s.executeEdits("my-source",[b]),s.focus()}}connectedCallback(){super.connectedCallback(),j("data",this.data)}render(){var s,a,e,o;let i,t;return(s=this.data)!=null&&s.thumbnail1x&&((a=this.data)!=null&&a.thumbnail2x)?i=r`<img
        src="${this.data.thumbnail1x}"
        srcset="${this.data.thumbnail2x} 2x, ${this.data.thumbnail1x}"
      />`:i=c,(e=this.data)!=null&&e.summary?t=[u.Guides,u.Images].includes((o=this.data)==null?void 0:o.group)?r`<p>${this.data.summary}</p>`:r`${B(this.data.summary)}`:t=c,r`
      ${this.data?r`
            <div>
              ${i}
              <div class="readable">
    ...
    `}createRenderRoot(){return this}};L([f({attribute:"component-data",type:Object})],P.prototype,"data",2);L([f({attribute:"t-messages",type:Object})],P.prototype,"tMessages",2);L([p()],P.prototype,"_showProps",2);P=L([x("guide-editor-component-list-item")],P);var st=Object.defineProperty,it=Object.getOwnPropertyDescriptor,I=(i,t,s,a)=>{for(var e=a>1?void 0:a?it(t,s):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(e=(a?n(t,s,e):n(e))||e);return a&&e&&st(t,s,e),e};let w=class extends C{constructor(){super(...arguments),this.tMessages={},this.tableHeaders=[],this._getAllPlacementsStatus=m.Initial,this._placements=[]}async _getAllPlacements(){var t;this._getAllPlacementsStatus=m.Loading;const i=await((t=window.Craft)==null?void 0:t.postActionRequest("guide/placement/get-all-placements"));this._placements=i.filter(s=>s.group===v.Nav),this._getAllPlacementsStatus=m.Success}async _onCmsGuideDisabled(i,t){var a;const s=this._placements.find(e=>e.guideId===i);s&&await((a=window.Craft)==null?void 0:a.postActionRequest("guide/placement/delete-placement",{data:{id:s.id}},(e,o)=>{var n;o==="success"&&(this._getAllPlacements(),window.Craft.cp.displayNotice((n=this.tMessages.placementDeleteSuccess)==null?void 0:n.replace("[guide]",t)))}))}async _onCmsGuideEnabled(i,t){var s;await((s=window.Craft)==null?void 0:s.postActionRequest("guide/placement/save-placement",{data:{access:"all",group:"nav",guideId:i}},(a,e)=>{var o;e==="success"&&(this._getAllPlacements(),window.Craft.cp.displayNotice((o=this.tMessages.placementSaveSuccess)==null?void 0:o.replace("[guide]",t)))}))}async connectedCallback(){super.connectedCallback(),await this._getAllPlacements()}render(){const i=this.tableHeaders.map(s=>r`<th>${s.label}</th>`),t=D.map(s=>{const a=[];a.push(O?r`<a href="${s.viewUrl}">${s.title}</a>`:r`<h3>${s.title}</h3>`),a.push(r`<p>${s.summary??""}</p>`),a.push(r`<guide-copy-text-button
        ...
        `),N.editGuides&&o.push(r`<a class="btn small secondary" data-icon="pencil" href="${s.editUrl}">${this.tMessages.edit}</a>`),N.deleteGuides&&o.push(r`<a class="btn small" data-icon="trash" href="${s.deleteUrl}">${this.tMessages.delete}</a>`),a.push(r`<div class="buttons">${o.map(n=>n)}</div>`),a});return r`
