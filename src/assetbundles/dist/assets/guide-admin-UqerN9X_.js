import{n as v,t as C,h as P,k as r,D as c,i as H,r as h,a as N,p as U,R as J,g as D,b as B,u as R}from"./globals-B1P9Mf0C.js";import{G as $,E as p,A as g,P as m,a as V,M as E}from"./types-DZ_LYyIe.js";import{l as W}from"./console-DyT9hXlL.js";async function z(s){if(navigator.clipboard&&window.isSecureContext)await navigator.clipboard.writeText(s);else{const t=document.createElement("textarea");t.value=s,t.classList.add("sr-only"),document.body.prepend(t),t.select();try{document.execCommand("copy")}catch(i){console.error(i)}finally{t.remove()}}}var Y=Object.defineProperty,K=Object.getOwnPropertyDescriptor,j=(s,t,i,a)=>{for(var e=a>1?void 0:a?K(t,i):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(e=(a?n(t,i,e):n(e))||e);return a&&e&&Y(t,i,e),e};let G=class extends P{constructor(){super(...arguments),this.tMessages={},this.copyText=""}async _copyTextToClipboard(s){await z(s),window.Craft.cp.displayNotice(`${this.tMessages.copiedToClipboard}: ${s}`)}async connectedCallback(){super.connectedCallback()}render(){return r`${this.copyText&&this.tMessages?r`
          <div
        ...
        `:c}`}createRenderRoot(){return this}};j([v({attribute:"t-messages",type:Object})],G.prototype,"tMessages",2);j([v({attribute:"copy-text",type:String})],G.prototype,"copyText",2);G=j([C("guide-copy-text-button")],G);var Q=Object.defineProperty,X=Object.getOwnPropertyDescriptor,b=(s,t,i,a)=>{for(var e=a>1?void 0:a?X(t,i):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(e=(a?n(t,i,e):n(e))||e);return a&&e&&Q(t,i,e),e};let _=class extends P{constructor(){super(...arguments),this.isNew=!1,this.tMessages={},this.templatesData={},this._componentLists=["settings"],this._contentEditor=null,this._contentSource=$.Field,this._contentSourceSelect=null,this._contentUrlField=null,this._contentUrl="",this._renderMarkdownField=null,this._selectedTabGroup=p.Settings,this._slugHasBeenEdited=!1,this._slugInput=null,this._templateField=null,this._template="__none__",this._titleInput=null}_onContentSourceChange(s){var t,i,a,e,o,n,l,u,f;switch(s){case $.Field:(t=this._contentUrlField)==null||t.classList.add("hidden"),(i=this._renderMarkdownField)==null||i.classList.remove("hidden"),(a=this._templateField)==null||a.classList.add("hidden"),this._contentSource=$.Field;break;case $.Iframe:(e=this._contentUrlField)==null||e.classList.remove("hidden"),(o=this._renderMarkdownField)==null||o.classList.add("hidden"),(n=this._templateField)==null||n.classList.add("hidden"),this._contentSource=$.Iframe;break;case $.Template:(l=this._contentUrlField)==null||l.classList.add("hidden"),(u=this._renderMarkdownField)==null||u.classList.add("hidden"),(f=this._templateField)==null||f.classList.remove("hidden"),this._contentSource=$.Template;break}}connectedCallback(){var i,a,e,o,n;super.connectedCallback(),this._contentSourceSelect=this.querySelector('guide-editor select[name="contentSource"]'),this._contentUrlField=this.querySelector("guide-editor #contentUrl-field"),this._renderMarkdownField=this.querySelector("guide-editor #renderMarkdown-field"),this._slugInput=this.querySelector('guide-editor input[name="slug"]'),this._templateField=this.querySelector("guide-editor #template-field"),this._titleInput=this.querySelector('guide-editor input[name="title"]'),this.isNew&&this._titleInput&&this._titleInput.addEventListener("input",()=>{var l,u;!this._slugHasBeenEdited&&this._slugInput&&(this._slugInput.value=N(((l=this._titleInput)==null?void 0:l.value)??""),(u=document.querySelector("guide-editor"))==null||u.setAttribute("data-guide-slug",this._slugInput.value))}),(i=this._slugInput)==null||i.addEventListener("blur",()=>{var l;if(this._slugInput){this._slugHasBeenEdited=!0,this._slugInput.value=N(this._slugInput.value);const u=document.querySelectorAll("guide-copy-text-button"),f=this._slugInput.value;u.forEach(w=>{w.copyText=f}),(l=document.querySelector("guide-editor"))==null||l.setAttribute("data-guide-slug",f)}}),(a=this._slugInput)!=null&&a.value&&((e=document.querySelector("guide-editor"))==null||e.setAttribute("data-guide-slug",this._slugInput.value)),this._contentSourceSelect&&(this._contentSourceSelect.addEventListener("change",()=>{var l;this._onContentSourceChange((l=this._contentSourceSelect)==null?void 0:l.value)}),this._onContentSourceChange(this._contentSourceSelect.value));const s=(o=this._contentUrlField)==null?void 0:o.querySelector("input");s&&(s.addEventListener("blur",()=>{s!=null&&s.value&&(this._contentUrl=s.value)}),this._contentUrl=s.value);const t=(n=this._templateField)==null?void 0:n.querySelector("select");if(t&&(t.addEventListener("change",()=>{t!=null&&t.value&&(this._template=t.value)}),this._template=t.value),this._contentEditor=globalThis.monacoEditorInstances.contentEditor,this._contentEditor){const l=this._contentEditor.getModel().getLineCount(),u=this._contentEditor.getModel().getLineMaxColumn(l);this._contentEditor.setPosition({column:u,lineNumber:l})}this.querySelector("#editor-component-list-components")&&this._componentLists.push("components"),this.querySelector("#editor-component-list-guides")&&this._componentLists.push("guides"),this.querySelector("#editor-component-list-images")&&this._componentLists.push("images"),this.querySelector("#editor-component-list-snippets")&&this._componentLists.push("snippets")}render(){const s=[];this._componentLists.includes(p.Components)&&s.push(r`
        <button
          class="${this._selectedTabGroup===p.Components?"active":c}"
          type="button"
          title="${this.tMessages.components}"
          @click="${()=>this._selectedTabGroup=p.Components}"
        >
          <slot name="icon-components"></slot><span>${this.tMessages.components}</span>
        </button>
      `),this._componentLists.includes(p.Images)&&s.push(r`
        <button
          class="${this._selectedTabGroup===p.Images?"active":c}"
          type="button"
          title="${this.tMessages.images}"
          @click="${()=>this._selectedTabGroup=p.Images}"
        >
          <slot name="icon-images"></slot><span>${this.tMessages.images}</span>
        </button>
      `),this._componentLists.includes(p.Guides)&&s.push(r`
        <button
          class="${this._selectedTabGroup===p.Guides?"active":c}"
          type="button"
          title="${this.tMessages.guides}"
          @click="${()=>this._selectedTabGroup=p.Guides}"
        >
          <slot name="icon-guides"></slot><span>${this.tMessages.guides}</span>
        </button>
      `),this._componentLists.includes(p.Snippets)&&s.push(r`
        <button
          class="${this._selectedTabGroup===p.Snippets?"active":c}"
          type="button"
          title="${this.tMessages.snippets}"
          @click="${()=>this._selectedTabGroup=p.Snippets}"
        >
      ...
      <aside>
        <div
          ...
          style="--guide-editor-content-buttons-columns: ${this._contentSource===$.Field?1+s.length:1};"
        >
          <button
            class="${this._selectedTabGroup===p.Settings?"active":c}"
            type="button"
            title="${this.tMessages.settings}"
            @click="${()=>this._selectedTabGroup=p.Settings}"
          >
            <slot name="icon-settings"></slot><span>${this.tMessages.settings}</span>
          </button>
          ${U&&this._contentSource===$.Field?s:c}
        </div>
        ${this._selectedTabGroup===p.Settings?r`<slot name="settings"></slot>`:c}
        ${this._selectedTabGroup===p.Components?r`<slot name="components"></slot>`:c}
        ${this._selectedTabGroup===p.Images?r`<slot name="images"></slot>`:c}
        ${this._selectedTabGroup===p.Guides?r`<slot name="guides"></slot>`:c}
        ${this._selectedTabGroup===p.Snippets?r`<slot name="snippets"></slot>`:c}
      </aside>
      ${t}
    `}};_.styles=H`
    :host {
 ...
 */class F extends et{constructor(t){if(super(t),this.it=c,t.type!==Z.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===c||t==null)return this._t=void 0,this.it=t;if(t===J)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}F.directiveName="unsafeHTML",F.resultType=1;const L=tt(F);var st=Object.defineProperty,it=Object.getOwnPropertyDescriptor,O=(s,t,i,a)=>{for(var e=a>1?void 0:a?it(t,i):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(e=(a?n(t,i,e):n(e))||e);return a&&e&&st(t,i,e),e};let I=class extends P{constructor(){super(...arguments),this.data=void 0,this.tMessages={},this._showProps=!1}_insertTextIntoEditor(s,t){var e;let i;t==="content"?i=globalThis.monacoEditorInstances.contentEditor:t==="css"?i=globalThis.monacoEditorInstances.contentCss:t==="javascript"&&(i=globalThis.monacoEditorInstances.contentJavascript);const a=(e=document.querySelector("guide-editor"))==null?void 0:e.dataset.guideSlug;if(a){const o=new Date;s=s.replace(/REPLACE_DATE/g,o.toISOString().split("T")[0]).replace(/REPLACE_GUIDE_SLUG/g,a)}if(i){const o=i.getModel().getLineCount(),n=i.getModel().getLineMaxColumn(o),l=i.getSelection(),f={identifier:{major:1,minor:1},range:{startLineNumber:(l==null?void 0:l.selectionStartLineNumber)??o,startColumn:(l==null?void 0:l.selectionStartColumn)??n,endLineNumber:(l==null?void 0:l.endLineNumber)??o,endColumn:(l==null?void 0:l.endColumn)??n},text:s,forceMoveMarkers:!0};i.executeEdits("my-source",[f]),i.focus()}}connectedCallback(){super.connectedCallback()}render(){var i,a,e,o;let s,t;return(i=this.data)!=null&&i.thumbnail1x&&((a=this.data)!=null&&a.thumbnail2x)?s=r`<img
                    ...
                    ${t.map(e=>{let o;if(s.name===m.Field){W(this.fieldsData,t);const n=t.map(l=>l.groupId??"");o=r`
                        ...
                        `}else s.name===m.Uri?o=r`
                          <div class="guide-organizer-section-flex-fields">
                            ...
                            <div class="select">
                              ...
                              >
                                <option value="before" ?selected="${e.moveMethod===E.Before}">
                                  before
                                </option>
                                <option value="prepend" ?selected="${e.moveMethod===E.Prepend}">
                                  at the top of
                                </option>
                                <option value="append" ?selected="${e.moveMethod===E.Append}">
                                  at the bottom of
                                </option>
                        ...
                        `:o=r`<div><span>${i[e.guideId].summary}</span></div>`;return i[e.guideId]?r`<li>
                            <div class="guide-organizer-title">
                              ${L(B)}<span>${i[e.guideId].title}</span>
                            </div>
    ...
    `}createRenderRoot(){return this}};A([v({attribute:"guides-data",type:Object})],x.prototype,"guidesData",2);A([v({attribute:"t-messages",type:Object})],x.prototype,"tMessages",2);A([h()],x.prototype,"_exportData",2);A([h()],x.prototype,"_selectedGuides",2);x=A([C("guide-utilities")],x);
