import{i as m,n as g,r as s,h as p,b as y,l as d,a as u,D as k,t as C}from"./console-7TmJNlmx.js";import{g as c,P as v,S as z,C as w,H as x,D as f,W as R,G as $}from"./GLTFLoader-CnsMw-IL.js";var P=Object.defineProperty,j=Object.getOwnPropertyDescriptor,i=(t,a,h,r)=>{for(var o=r>1?void 0:r?j(a,h):a,b=t.length-1,n;b>=0;b--)(n=t[b])&&(o=(r?n(a,h,o):n(o))||o);return r&&o&&P(a,h,o),o};let e=class extends p{constructor(){super(...arguments),this._container=null,this.tMessages={},this._animationState="intro",this._debugIncrement=.5,this._debugCameraX=0,this._debugCameraY=0,this._debugCameraZ=0,this._debugCameraRotateX=0,this._debugCameraRotateY=0,this._debugCameraRotateZ=0,this._objectUrl=`${y}/guide-book.gltf`,this._resizeObserver=null,this._settings={animation:{rotation:{x:0,y:0,z:0,xSineMax:0}},camera:{fov:60,near:.1,far:30,position:{x:4.9889,y:8.69,z:1.19},rotation:{x:4.89,y:.249,z:0}},lights:{ambient:{groundColor:2236962,intensity:1,skyColor:16777215},directional:{color:16777215,intensity:4,position:{x:10,y:10,z:10}}},object:{scale:{x:1,y:1,z:1},rotation:{x:0,y:0,z:0}},scene:{bgColor:"white"}},this._showDebugControls=!1}_animateOpenBook(){if(this._bookTop&&this._bookLoose&&this._bookLoose2){this._animationState="animating";const t=3;c.to(this._bookTop.rotation,{duration:t,z:.6,ease:"elastic.out(1, 0.3)",onComplete:()=>{this._animationState="opened"}}),c.to(this._bookLoose.rotation,{duration:t,z:.15,ease:"elastic.out(1, 0.3)"}),c.to(this._bookLoose2.rotation,{duration:t,z:.02,ease:"elastic.out(1, 0.3)"})}}_animateCloseBook(){if(this._bookTop&&this._bookLoose&&this._bookLoose2){this._animationState="animating";const t=1;c.to(this._bookTop.rotation,{duration:t,z:0,ease:"power4.in",onComplete:()=>{this._animationState="closed"}}),c.to(this._bookLoose.rotation,{duration:t,z:-.05,ease:"power4.in"}),c.to(this._bookLoose2.rotation,{duration:t,z:-.05,ease:"power4.in"})}}_debugButtonPressed(t){if(this._camera){switch(t){case"xUp":this._camera.position.x+=this._debugIncrement;break;case"xDown":this._camera.position.x-=this._debugIncrement;break;case"yUp":this._camera.position.y+=this._debugIncrement;break;case"yDown":this._camera.position.y-=this._debugIncrement;break;case"zUp":this._camera.position.z+=this._debugIncrement;break;case"zDown":this._camera.position.z-=this._debugIncrement;break;case"xRotateUp":this._camera.rotation.x+=this._debugIncrement;break;case"xRotateDown":this._camera.rotation.x-=this._debugIncrement;break;case"yRotateUp":this._camera.rotation.y+=this._debugIncrement;break;case"yRotateDown":this._camera.rotation.y-=this._debugIncrement;break;case"zRotateUp":this._camera.rotation.z+=this._debugIncrement;break;case"zRotateDown":this._camera.rotation.z-=this._debugIncrement;break;case"i0_1":this._debugIncrement=.1;break;case"i0_5":this._debugIncrement=.5;break;case"i1":this._debugIncrement=1;break}this._debugCameraX=this._camera.position.x,this._debugCameraY=this._camera.position.y,this._debugCameraZ=this._camera.position.z,this._debugCameraRotateX=this._camera.rotation.x,this._debugCameraRotateY=this._camera.rotation.y,this._debugCameraRotateZ=this._camera.rotation.z,d("Camera",`position x: ${this._camera.position.x}`,`position y: ${this._camera.position.y}`,`position z: ${this._camera.position.z}`,`rotation x: ${this._camera.rotation.x}`,`rotation y: ${this._camera.rotation.y}`,`rotation z: ${this._camera.rotation.z}`)}}_init(){var t;if(this._container=((t=this.renderRoot)==null?void 0:t.querySelector("#guide-book-scene-container"))??null,d("contianer",this._container),this._container){const a=this._settings.camera.fov,h=this._container.clientWidth/this._container.clientHeight,r=this._settings.camera.near,o=this._settings.camera.far;this._camera=new v(a,h,r,o),this._camera.position.set(this._settings.camera.position.x,this._settings.camera.position.y,this._settings.camera.position.z),this._camera.rotation.set(this._settings.camera.rotation.x,this._settings.camera.rotation.y,this._settings.camera.rotation.z),this._scene=new z,this._scene.background=new w(this._settings.scene.bgColor),this._ambientLight=new x(this._settings.lights.ambient.skyColor,this._settings.lights.ambient.groundColor,this._settings.lights.ambient.intensity),this._mainLight=new f(this._settings.lights.directional.color,this._settings.lights.directional.intensity),this._mainLight.position.set(this._settings.lights.directional.position.x,this._settings.lights.directional.position.y,this._settings.lights.directional.position.z),this._scene.add(this._ambientLight,this._mainLight),this._renderer=new R({antialias:!0,powerPreference:"high-performance"}),this._renderer.setSize(this._container.clientWidth,this._container.clientHeight),this._renderer.setPixelRatio(window.devicePixelRatio),this._container.appendChild(this._renderer.domElement),this._camera.aspect=this._container.clientWidth/this._container.clientHeight,this._camera.updateProjectionMatrix(),this._renderer.setSize(this._container.clientWidth,this._container.clientHeight),new $().load(this._objectUrl,n=>{if(this._object=n,this._object.scene.scale.set(this._settings.object.scale.x,this._settings.object.scale.y,this._settings.object.scale.z),this._object.scene.rotation.set(this._settings.object.rotation.x,this._settings.object.rotation.y,this._settings.object.rotation.z),this._scene.add(this._object.scene),this._showDebugControls){const _=[];this._object.scene.traverse(l=>{_.push(l)})}this._bookTop=this._object.scene.getObjectByName("Top"),this._bookLoose=this._object.scene.getObjectByName("Loose"),this._bookLoose2=this._object.scene.getObjectByName("Loose_2"),d("Objects from scene",this._bookTop,this._bookLoose,this._bookLoose2)},void 0,void 0),this._renderer.setAnimationLoop(()=>{this._object&&this._renderer.render(this._scene,this._camera)}),this._resizeObserver=new ResizeObserver(n=>{if(this._container)for(let _ of n)_.contentBoxSize&&(this._camera.aspect=this._container.clientWidth/this._container.clientHeight,this._camera.updateProjectionMatrix(),this._renderer.setSize(this._container.clientWidth,this._container.clientHeight))}),this._resizeObserver&&this._resizeObserver.observe(this._container),this._animationState="closed"}}_onContainerClicked(){this._animationState==="opened"?this._animateCloseBook():this._animationState==="closed"&&this._animateOpenBook()}firstUpdated(t){super.firstUpdated(t),this._init()}render(){return u`
  ...
  `;i([g({attribute:"t-messages",type:Object})],e.prototype,"tMessages",2);i([s()],e.prototype,"_animationState",2);i([s()],e.prototype,"_debugIncrement",2);i([s()],e.prototype,"_debugCameraX",2);i([s()],e.prototype,"_debugCameraY",2);i([s()],e.prototype,"_debugCameraZ",2);i([s()],e.prototype,"_debugCameraRotateX",2);i([s()],e.prototype,"_debugCameraRotateY",2);i([s()],e.prototype,"_debugCameraRotateZ",2);i([s()],e.prototype,"_objectUrl",2);i([s()],e.prototype,"_resizeObserver",2);i([s()],e.prototype,"_settings",2);i([s()],e.prototype,"_showDebugControls",2);e=i([C("guide-book")],e);
