...
//                            break;
    ...
    public function renderAdminGlobals()
    {
        ...
        $translationKeys = [
            ...
            'View',
            'EDITOR_ADD_PAGE_URL',
            'EDITOR_TAB_INSTRUCTIONS_COMPONENTS',
            ...
            'EDITOR_TEMPLATE_SELECT_FILE',
            'EDITOR_URL_LOADED_IN_IFRAME_PREFIX',
            'ORGANIZER_CP_INSTRUCTIONS',
            'ORGANIZER_GUIDES_INSTRUCTIONS',
            'PLACEMENT_EDITOR_FIELD_INSTRUCTIONS_GROUP',
            'PLACEMENT_EDITOR_FIELD_INSTRUCTIONS_SELECTOR_URI',
            'PLACEMENT_EDITOR_FIELD_INSTRUCTIONS_SELECTOR_NON_URI',
            'PLACEMENT_EDITOR_FIELD_INSTRUCTIONS_URI',
            'PLACEMENT_INLINE_EDITOR_CONFIRM_ADDED',
            'PLACEMENT_INLINE_EDITOR_CONFIRM_REMOVED',
            'PLACEMENT_INLINE_EDITOR_FIELD_INSTRUCTIONS_GUIDE',
            'PLACEMENT_INLINE_EDITOR_NO_GUIDES',
